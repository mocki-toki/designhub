                ...
                SizedBox(
                  ...
                  child: logic.isDraftNotifier.builder(
                    ...
                    child: Column(
                      ...
                      children: [
                        ListTile(
                          title: Text(context.appLocalizations.newDateButton),
                        ...
                        if (dates.isEmpty)
                          ListTile(
                            title:
                                Text(context.appLocalizations.noDatesMessage),
                          ),
                        Expanded(
                            ...
                            Row(
                              children: [
                                ...
                                IntrinsicWidth(
                                  child: ListTile(
                                    title: Text(context
                                        .appLocalizations.deleteDateButton),
    ...
    return AlertDialog(
      ...
      content: TextField(
        ...
        decoration: InputDecoration(
          hintText: context.appLocalizations.linkUrlHint,
        ),
      ),
      actions: [
        TextButton(
          ...
          child: Text(context.appLocalizations.uploadFileButton),
        ),
        TextButton(
